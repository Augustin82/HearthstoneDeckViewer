...
var $author$project$Main$Card = function (id) {
	return function (dbfId) {
		return function (artist) {
			return function (_class) {
				return function (collectible) {
											...
											return function (text) {
												return function (attack) {
													return function (health) {
														return {artist: artist, attack: attack, _class: _class, collectible: collectible, cost: cost, dbfId: dbfId, flavor: flavor, health: health, id: id, name: name, rarity: rarity, set: set, text: text, type_: type_};
													};
												};
											};
										};
...
var $author$project$Main$optional = F2(
	function (field, dec) {
		return $elm$json$Json$Decode$oneOf(
			_List_fromArray(
				[
...
var $author$project$Main$cardDecoder = A2(
	$author$project$Main$andMap,
	A2($author$project$Main$optional, 'health', $elm$json$Json$Decode$int),
	A2(
		$author$project$Main$andMap,
		A2($author$project$Main$optional, 'attack', $elm$json$Json$Decode$int),
		A2(
			$author$project$Main$andMap,
			A2($author$project$Main$optional, 'text', $elm$json$Json$Decode$string),
			A2(
				$author$project$Main$andMap,
				A2($elm$json$Json$Decode$field, 'type', $elm$json$Json$Decode$string),
				A2(
					$author$project$Main$andMap,
					A2($elm$json$Json$Decode$field, 'set', $elm$json$Json$Decode$string),
					A2(
						$author$project$Main$andMap,
						A2($elm$json$Json$Decode$field, 'rarity', $elm$json$Json$Decode$string),
						A2(
							$author$project$Main$andMap,
							A2($elm$json$Json$Decode$field, 'name', $elm$json$Json$Decode$string),
							A2(
								$author$project$Main$andMap,
								A2($author$project$Main$optional, 'flavor', $elm$json$Json$Decode$string),
								A2(
									$author$project$Main$andMap,
									A2($author$project$Main$optional, 'cost', $elm$json$Json$Decode$int),
									A2(
										$author$project$Main$andMap,
										A2($elm$json$Json$Decode$field, 'collectible', $elm$json$Json$Decode$bool),
										A2(
											$author$project$Main$andMap,
											A2($elm$json$Json$Decode$field, 'cardClass', $elm$json$Json$Decode$string),
											A2(
												$author$project$Main$andMap,
												A2($author$project$Main$optional, 'artist', $elm$json$Json$Decode$string),
												A2(
													$author$project$Main$andMap,
													A2($elm$json$Json$Decode$field, 'dbfId', $elm$json$Json$Decode$int),
													A2(
														$author$project$Main$andMap,
...
var $author$project$Main$cardsDecoder = A2(
	$elm$json$Json$Decode$map,
	A2(
		$elm$core$Basics$composeR,
		$elm$core$List$map(
			function (card) {
				return _Utils_Tuple2(card.dbfId, card);
			}),
...
var $author$project$Main$hearthstoneAPICardsURl = 'https://api.hearthstonejson.com/v1/latest/enUS/cards.collectible.json';
var $author$project$Main$fetchCards = $elm$http$Http$get(
	{
		expect: A2(
			$elm$http$Http$expectJson,
			A2($elm$core$Basics$composeR, $krisajenkins$remotedata$RemoteData$fromResult, $author$project$Main$GotCards),
			$author$project$Main$cardsDecoder),
		url: $author$project$Main$hearthstoneAPICardsURl
	});
var $author$project$Main$init = F3(
	function (_v0, url, key) {
		return _Utils_Tuple2(
			{cards: $krisajenkins$remotedata$RemoteData$NotAsked, decodedDeck: $elm$core$Dict$empty, key: key, pasted: ''},
			$author$project$Main$fetchCards);
	});
var $author$project$Main$DecodedDeck = F2(
	function (a, b) {
		return {$: 'DecodedDeck', a: a, b: b};
	});
var $elm$json$Json$Decode$value = _Json_decodeValue;
var $author$project$Main$deckDecoded = _Platform_incomingPort('deckDecoded', $elm$json$Json$Decode$value);
var $author$project$Main$Deck = F3(
	function (cards, format, heroes) {
		return {cards: cards, format: format, heroes: heroes};
	});
var $elm$json$Json$Decode$andThen = _Json_andThen;
var $elm$json$Json$Decode$fail = _Json_fail;
var $author$project$Main$deckCardsDecoder = A2(
			...
			switch (qty) {
				...
				case 2:
					return $elm$json$Json$Decode$succeed(
						_Utils_Tuple2(id, 2));
				default:
					return $elm$json$Json$Decode$fail('Quantity must be 1 or 2');
			}
		} else {
			return $elm$json$Json$Decode$fail('Expecting exactly two elements in array');
		}
	},
...
var $author$project$Main$deckDecoder = A2(
	$author$project$Main$andMap,
	A2(
		$elm$json$Json$Decode$field,
		'deck',
		A2(
			...
			A2(
				$author$project$Main$andMap,
				A2($elm$json$Json$Decode$field, 'format', $elm$json$Json$Decode$int),
				A2(
					$author$project$Main$andMap,
					A2(
						$elm$json$Json$Decode$field,
						'cards',
						$elm$json$Json$Decode$list($author$project$Main$deckCardsDecoder)),
					$elm$json$Json$Decode$succeed($author$project$Main$Deck))))),
	A2(
		$author$project$Main$andMap,
		A2($elm$json$Json$Decode$field, 'deckstring', $elm$json$Json$Decode$string),
...
var $author$project$Main$subscriptions = function (_v0) {
	return $author$project$Main$deckDecoded(
		A2(
			$elm$core$Basics$composeR,
			$elm$json$Json$Decode$decodeValue($author$project$Main$deckDecoder),
			A2(
				$elm$core$Basics$composeR,
				$elm$core$Result$map(
					function (_v1) {
						var deckstring = _v1.a;
						var deck = _v1.b;
						return A2(
							$author$project$Main$DecodedDeck,
							deckstring,
							$elm$core$Result$Ok(deck));
					}),
...
var $author$project$Main$decodeDeck = _Platform_outgoingPort('decodeDeck', $elm$json$Json$Encode$string);
			...
			case 'AddDecks':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							decodedDeck: A3($elm$core$Dict$insert, model.pasted, $krisajenkins$remotedata$RemoteData$Loading, model.decodedDeck),
							pasted: ''
						}),
					$elm$core$Platform$Cmd$batch(
						_List_fromArray(
							[
								$author$project$Main$decodeDeck(model.pasted),
								A2(
								$elm$browser$Browser$Navigation$pushUrl,
								model.key,
								A2(
									...
									A2(
										$elm$core$List$map,
										$elm$url$Url$Builder$string('deckstring'),
										A2(
											$elm$core$String$split,
											',',
											A3($elm$core$String$replace, ' ', ',', model.pasted)))))
							])));
			case 'DecodedDeck':
				var deckstring = msg.a;
				var deck = msg.b;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							decodedDeck: A3(
								...
								A2(
									...
									$krisajenkins$remotedata$RemoteData$fromResult(deck)),
								model.decodedDeck)
						}),
					$elm$core$Platform$Cmd$none);
			default:
...
var $author$project$Main$AddDecks = {$: 'AddDecks'};
...
var $author$project$Main$deckButtons = $mdgriffith$elm_ui$Element$none;
...
var $author$project$Main$imageUrlForId = function (id) {
	return '/images/tiles/' + (id + '.png');
};
var $author$project$Main$manaCrystal = '/images/mana_crystal.png';
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					$author$project$Main$imageUrlForId(id))
				]),
			_List_fromArray(
				[
					A2(
					...
					_List_fromArray(
						[
							...
							$mdgriffith$elm_ui$Element$Background$color(
							A3($mdgriffith$elm_ui$Element$rgb255, 22, 26, 58)),
							$mdgriffith$elm_ui$Element$htmlAttribute(
							A2($elm$html$Html$Attributes$style, 'background-image', 'url(' + ($author$project$Main$manaCrystal + ')'))),
							$mdgriffith$elm_ui$Element$htmlAttribute(
							A2($elm$html$Html$Attributes$style, 'background-size', '25px 22.5px')),
							$mdgriffith$elm_ui$Element$htmlAttribute(
							A2($elm$html$Html$Attributes$style, 'background-repeat', 'no-repeat')),
							$mdgriffith$elm_ui$Element$htmlAttribute(
							A2($elm$html$Html$Attributes$style, 'background-position', 'right top 3px')),
							$mdgriffith$elm_ui$Element$height($mdgriffith$elm_ui$Element$fill)
						]),
					A2(
						$mdgriffith$elm_ui$Element$el,
						...
						$mdgriffith$elm_ui$Element$text(
							A2(
								$elm$core$Maybe$withDefault,
								'',
								A2($elm$core$Maybe$map, $elm$core$String$fromInt, cost))))),
					A2(
					$mdgriffith$elm_ui$Element$el,
					_List_fromArray(
						[
							...
							$mdgriffith$elm_ui$Element$height($mdgriffith$elm_ui$Element$fill),
							$mdgriffith$elm_ui$Element$htmlAttribute(
							A2($elm$html$Html$Attributes$style, 'background', 'linear-gradient(45deg, rgba(22,26,58,1) 0%,rgba(15,18,41,1) 30%,rgba(0,0,0,0) 100%)'))
						]),
					A2(
						$mdgriffith$elm_ui$Element$el,
						_List_fromArray(
...
var $author$project$Main$deckCards = F2(
	function (cards, deck) {
		return A2(
			...
			A2(
				...
				function (_v0) {
					...
					if (maybeCard.$ === 'Nothing') {
						...
						return A2($author$project$Main$viewDeckCard, card, qty);
					}
				},
				A2(
						...
						$elm$core$Tuple$mapFirst(
							function (dbfId) {
								return A2(
									$elm$core$Dict$get,
									dbfId,
									A2($krisajenkins$remotedata$RemoteData$withDefault, $elm$core$Dict$empty, cards));
							}),
						deck.cards))));
	});
var $author$project$Main$imageUrlForHero = F2(
	function (cards, dbfId) {
		var id = A2(
			$elm$core$Maybe$withDefault,
			'',
			A2(
				...
				A2(
					...
					dbfId,
					A2($krisajenkins$remotedata$RemoteData$withDefault, $elm$core$Dict$empty, cards))));
		return '/images/heroes/' + (id + '.png');
	});
var $author$project$Main$deckTitle = F2(
	function (cards, deck) {
		return A2(
			$elm$core$Maybe$withDefault,
				...
				function (_int) {
					return A2(
						...
						_List_fromArray(
							[
								$mdgriffith$elm_ui$Element$Background$image(
								A2($author$project$Main$imageUrlForHero, cards, _int))
							]),
						$mdgriffith$elm_ui$Element$none);
				},
				$elm$core$List$head(deck.heroes)));
	});
		...
		switch (deck.$) {
			...
			default:
				...
				return A2(
					...
					_List_fromArray(
						[
							A2($author$project$Main$deckTitle, cards, d),
							A2($author$project$Main$deckCards, cards, d),
							$author$project$Main$deckButtons
						]));
		}
	});
...
var $author$project$Main$view = function (_v0) {
	var pasted = _v0.pasted;
	var cards = _v0.cards;
	var decodedDeck = _v0.decodedDeck;
	return {
		body: _List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$text('*:focus { outline: none !important; box-shadow: none !important;  }')
					])),
				A2(
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									$mdgriffith$elm_ui$Element$htmlAttribute(
									$elm$html$Html$Attributes$id('header-section')),
									$mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill),
									$mdgriffith$elm_ui$Element$htmlAttribute(
									A2(
										$elm$core$List$any,
										$krisajenkins$remotedata$RemoteData$isSuccess,
										$elm$core$Dict$values(decodedDeck)) ? $elm$html$Html$Attributes$class('') : A2($elm$html$Html$Attributes$style, 'min-height', '100vh'))
								]),
							A2(
								$mdgriffith$elm_ui$Element$el,
								_List_fromArray(
								...
								A2(
									...
									_List_fromArray(
										[
											...
											$mdgriffith$elm_ui$Element$text('Hearthstone Deck Viewer')),
											A2(
											$mdgriffith$elm_ui$Element$row,
											_List_fromArray(
												[
														...
														[
															...
															_List_fromArray(
																[
																	$mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill),
																	$mdgriffith$elm_ui$Element$Font$color(
																	A3($mdgriffith$elm_ui$Element$rgb255, 73, 80, 87))
																]),
															_List_fromArray(
																[
																	A2(
																	...
																	_List_fromArray(
																		[
																			$mdgriffith$elm_ui$Element$htmlAttribute(
																			$elm$html$Html$Attributes$id('deckstring')),
																			$mdgriffith$elm_ui$Element$htmlAttribute(
																			$elm$html$Html$Attributes$name('deckstring')),
																			$mdgriffith$elm_ui$Element$height($mdgriffith$elm_ui$Element$fill),
																			$mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill),
																		...
																		]),
																	{
																		...
																		onChange: $author$project$Main$UpdateInput,
																		placeholder: $elm$core$Maybe$Just(
																			A2(
																				$mdgriffith$elm_ui$Element$Input$placeholder,
																				_List_Nil,
																				$mdgriffith$elm_ui$Element$text('Input deck code(s) here'))),
																		text: pasted
																	}),
																	A2(
																	...
																	_List_fromArray(
																		[
																			$mdgriffith$elm_ui$Element$htmlAttribute(
																			$elm$html$Html$Attributes$id('addButton')),
																			$mdgriffith$elm_ui$Element$Font$color(
																			A3($mdgriffith$elm_ui$Element$rgb255, 255, 255, 255)),
																	...
																	{
																		label: $mdgriffith$elm_ui$Element$text('Add Deck(s)'),
																		onPress: $elm$core$Maybe$Just($author$project$Main$AddDecks)
																	})
																])),
															A2(
															$mdgriffith$elm_ui$Element$el,
															_List_fromArray(
																[
																	...
																	$mdgriffith$elm_ui$Element$Font$color(
																	A3($mdgriffith$elm_ui$Element$rgb255, 108, 117, 125)),
																	$mdgriffith$elm_ui$Element$centerX
																]),
															$mdgriffith$elm_ui$Element$text('Separate multiple deck codes with whitespace or commas. Individual deck strings copied from the game client are also supported.')),
															(!A2(
															$elm$core$List$any,
															$krisajenkins$remotedata$RemoteData$isSuccess,
															$elm$core$Dict$values(decodedDeck))) ? $mdgriffith$elm_ui$Element$none : A2(
															$mdgriffith$elm_ui$Element$row,
															_List_fromArray(
																[
																	$mdgriffith$elm_ui$Element$htmlAttribute(
																	$elm$html$Html$Attributes$id('shortURLForm')),
																	$mdgriffith$elm_ui$Element$centerX,
															...
															_List_fromArray(
																[
																	...
																	_List_fromArray(
																		[
																			$mdgriffith$elm_ui$Element$htmlAttribute(
																			$elm$html$Html$Attributes$id('urlButton')),
																			$mdgriffith$elm_ui$Element$Font$color(
																			A3($mdgriffith$elm_ui$Element$rgb255, 255, 255, 255)),
																			$mdgriffith$elm_ui$Element$Border$widthEach(
																	...
																	{
																		label: $mdgriffith$elm_ui$Element$text('Generate Short URL'),
																	...
																	_List_fromArray(
																		[
																			$mdgriffith$elm_ui$Element$htmlAttribute(
																			$elm$html$Html$Attributes$id('copyButton')),
																			$mdgriffith$elm_ui$Element$Font$color(
																			A3($mdgriffith$elm_ui$Element$rgb255, 255, 255, 255)),
																			$mdgriffith$elm_ui$Element$Border$widthEach(
																			{bottom: 1, left: 0, right: 1, top: 1}),
																		...
																		]),
																	{
																		label: A2(
																			...
																			_List_fromArray(
																				[
																					$mdgriffith$elm_ui$Element$htmlAttribute(
																					$elm$html$Html$Attributes$class('clippy')),
																					$mdgriffith$elm_ui$Element$width(
																					$mdgriffith$elm_ui$Element$px(13))
																				]),
																			{description: 'Copy to clipboard', src: 'images/clippy.svg'}),
																		onPress: $elm$core$Maybe$Nothing
																	})
																])),
															(!A2(
															...
															_List_fromArray(
																[
																	$mdgriffith$elm_ui$Element$htmlAttribute(
																	$elm$html$Html$Attributes$id('removeButton')),
																	$mdgriffith$elm_ui$Element$Font$color(
																	A3($mdgriffith$elm_ui$Element$rgb255, 255, 255, 255)),
																	$mdgriffith$elm_ui$Element$Border$width(1),
																	$mdgriffith$elm_ui$Element$Border$color(
															...
															{
																label: $mdgriffith$elm_ui$Element$text('Remove All Decks'),
																onPress: $elm$core$Maybe$Nothing
															})
														])),
													A2(
							...
							_List_fromArray(
								[
									$mdgriffith$elm_ui$Element$htmlAttribute(
									$elm$html$Html$Attributes$id('decks')),
									$mdgriffith$elm_ui$Element$Background$color(
									A3($mdgriffith$elm_ui$Element$rgb255, 255, 255, 255)),
									$mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill),
									$mdgriffith$elm_ui$Element$height($mdgriffith$elm_ui$Element$fill)
							...
							A2(
								...
								function (deck) {
									return A2(
										...
										_List_fromArray(
											[$mdgriffith$elm_ui$Element$centerX]),
										A2($author$project$Main$viewDeck, cards, deck));
								},
								$elm$core$Dict$values(decodedDeck)))
						])))
			]),
